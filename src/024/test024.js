...
var boxArray = app.createVertexArray().vertexAttributeBuffer(0, positions).vertexAttributeBuffer(1, uv).vertexAttributeBuffer(2, normals);
...
var sceneUniformBuffer = app.createUniformBuffer([app.gl.FLOAT_MAT4, app.gl.FLOAT_VEC4, app.gl.FLOAT_VEC4]).set(0, viewProjMatrix).set(1, eyePosition).set(2, lightPosition).update();
...
ImageFile('logo', '../assets/512x512.png').load().then(file => {
  ...
  var drawCall = app.createDrawCall(program, boxArray).uniformBlock("SceneUniforms", sceneUniformBuffer).texture("tex", texture);
...
//# sourceMappingURL=test024.js.map
