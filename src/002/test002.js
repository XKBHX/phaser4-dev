...
new Game(a=>{var b=new Loader.LoaderPlugin;a.draw("Phaser 4 Test 002"),b.image("logo","../assets/logo.png").then(b=>{for(var e=0;10>e;e++){var c=700*Math.random(),d=500*Math.random();a.drawImage(b.data,c,d);}}).catch(()=>{console.log("failed");}),b.start();});
