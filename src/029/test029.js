...
var quad = new Quad(4, 8, 32, 32);
var UVTL = new Vec2(0, 1);
var UVTR = new Vec2(1, 1);
var UVBL = new Vec2(0, 0);
var UVBR = new Vec2(1, 0);
var size = 4;
var dataTA = new Float32Array([quad.topLeft.x, quad.topLeft.y, UVTL.x, UVTL.y, quad.topRight.x, quad.topRight.y, UVTR.x, UVTR.y, quad.bottomLeft.x, quad.bottomLeft.y, UVBL.x, UVBL.y, quad.bottomLeft.x, quad.bottomLeft.y, UVBL.x, UVBL.y, quad.topRight.x, quad.topRight.y, UVTR.x, UVTR.y, quad.bottomRight.x, quad.bottomRight.y, UVBR.x, UVBR.y]);
...
//# sourceMappingURL=test029.js.map
