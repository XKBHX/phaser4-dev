...
var positions = app.createVertexBuffer(app.gl.FLOAT, 2, new Float32Array([-0.5, -0.5, 0.5, -0.5, 0.0, 0.5]));
var colors = app.createVertexBuffer(app.gl.UNSIGNED_BYTE, 3, new Uint8Array([255, 0, 0, 0, 255, 0, 0, 0, 255]));
